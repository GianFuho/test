...
//		sendFile();
	...
	public static void sendText() throws AddressException, MessagingException {
		...
		mailMessage.addRecipient(Message.RecipientType.TO, new InternetAddress("giangtctse63453@fpt.edu.vn"));
		...
		transport.connect("smtp.gmail.com", "giang030198@gmail.com", "0983975910");
